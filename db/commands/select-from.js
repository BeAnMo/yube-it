...
exports.allUserExts = `\
SELECT * FROM users WHERE user_ref = (\
SELECT user_id FROM users WHERE user_name = ?\
)`;

/*------- WHERE user_ref = ... user_name = ? ------------*/
exports.allUserExtsWhere = `\
SELECT users_exts.* FROM users_exts \
WHERE user_ref = (\
SELECT user_id FROM users WHERE user_name = ?\
)`;
...
SELECT post_title, post_created FROM posts WHERE post_id = ?\
`;        

/*------- posts* DESC ORDER -----------------------------*/
exports.allPostsDESC = `\
SELECT * FROM posts ORDER BY post_created DESC\
`;
